...
<div id="alert" class="alert" style="display:none;">
	<script>
		...
		alert.style.display = "<?php echo isset($_SESSION["reset_passwd"])?'':'none';?>";
		alert.innerText = "<?php echo isset($_SESSION["reset_passwd"])?$_SESSION["reset_passwd"]:'';?>";	
	</script>
</div>
